# Tutorial 4 Création du mini CMDB.    
## Table des matières
- [Objectifs](#objectifs)  
...
Les actions de notre futur playbook :
- création d'un dossier de travail sur le home sur toutes nos machines (control et managed node)..  
- affichage des gather_facts 
- affichage du nom de host
- generation d'un rapport au format markdown via un template sur chaque machine.
- copie de tous les rapport sur les machines hôtes vers notre machine de contrpole (ubuntu-c).
## Ressources 
- Environnement 
- Temps : 60 mn.
## Pré-Requis
...
## Énoncé  
### Etape 1 création du projet TP04 dans myWork.
1. copiez le projet TP03 en TP04.
